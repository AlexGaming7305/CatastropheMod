...
public class Modelabyssal_slime<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "abyssal_slime"), "main");
	private final ModelPart slime;
	private final ModelPart crystals;
	private final ModelPart crystals2;
	private final ModelPart crystals3;
	private final ModelPart crystals4;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition slime = partdefinition.addOrReplaceChild("slime",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-16.0F, -31.0F, -16.0F, 31.0F, 31.0F, 33.0F, new CubeDeformation(0.0F)).texOffs(36, 92)
						.addBox(-17.0F, -24.0F, -17.0F, 10.0F, 9.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(91, 83)
						.addBox(6.0F, -24.0F, -17.0F, 10.0F, 9.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(95, 0)
						.addBox(-7.0F, -8.0F, -17.0F, 6.0F, 5.0F, 9.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition crystals = partdefinition.addOrReplaceChild("crystals",
				CubeListBuilder.create().texOffs(36, 64)
						.addBox(19.0F, -20.0F, 0.0F, 9.0F, 20.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(74, 96)
						.addBox(19.0F, -27.0F, 3.0F, 6.0F, 7.0F, 5.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition crystals2 = partdefinition.addOrReplaceChild("crystals2",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(22.0F, -20.0F, -2.0F, 8.0F, 20.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(100, 64)
						.addBox(22.0F, -27.0F, 1.0F, 5.0F, 7.0F, 5.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition crystals3 = partdefinition.addOrReplaceChild("crystals3",
				CubeListBuilder.create().texOffs(70, 64)
						.addBox(22.0F, -20.0F, 0.0F, 7.0F, 20.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(96, 101)
						.addBox(22.0F, -27.0F, 3.0F, 4.0F, 7.0F, 5.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition crystals4 = partdefinition.addOrReplaceChild("crystals4",
				CubeListBuilder.create().texOffs(0, 64)
						.addBox(22.0F, -20.0F, -3.0F, 9.0F, 40.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(95, 14)
						.addBox(22.0F, -27.0F, 0.0F, 6.0F, 8.0F, 6.0F, new CubeDeformation(0.0F)),
