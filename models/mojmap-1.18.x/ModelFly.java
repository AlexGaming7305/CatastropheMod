	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Fly = partdefinition.addOrReplaceChild("Fly",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-1.0F, -2.0F, -2.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(6, 0)
						.addBox(-3.0F, -1.0F, -1.0F, 2.0F, 0.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 6)
						.addBox(1.0F, -1.0F, -1.0F, 2.0F, 0.0F, 2.0F, new CubeDeformation(0.0F)),
