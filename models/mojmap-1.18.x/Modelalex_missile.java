...
public class Modelalex_missile<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "alex_missile"), "main");
	private final ModelPart alex_missile;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition alex_missile = partdefinition.addOrReplaceChild("alex_missile",
				CubeListBuilder.create().texOffs(27, 44)
						.addBox(-1.0F, -7.0F, -11.0F, 2.0F, 2.0F, 19.0F, new CubeDeformation(0.0F)).texOffs(0, 23)
						.addBox(-1.0F, -9.0F, -5.0F, 2.0F, 2.0F, 21.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-1.0F, -5.0F, -5.0F, 2.0F, 2.0F, 21.0F, new CubeDeformation(0.0F)).texOffs(25, 23)
						.addBox(-3.0F, -7.0F, -5.0F, 2.0F, 2.0F, 19.0F, new CubeDeformation(0.0F)).texOffs(25, 0)
