...
public class Modelrubybolt<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "rubybolt"), "main");
	private final ModelPart rubybolt;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition rubybolt = partdefinition.addOrReplaceChild("rubybolt",
				CubeListBuilder.create().texOffs(13, 18)
						.addBox(-1.0F, -1.0F, -6.0F, 1.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(11, 10)
						.addBox(-2.0F, -1.0F, -4.0F, 1.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(11, 0)
						.addBox(0.0F, -1.0F, -4.0F, 1.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(0, 10)
						.addBox(-1.0F, -2.0F, -4.0F, 1.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
