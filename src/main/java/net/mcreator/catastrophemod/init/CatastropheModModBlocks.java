...
import net.mcreator.catastrophemod.block.SteelPlatingBlock;
import net.mcreator.catastrophemod.block.SteelPanelBlock;
...
import net.mcreator.catastrophemod.block.ReinforcedConcreteBlock;
...
import net.mcreator.catastrophemod.block.CorrodedSteelPlatingBlock;
import net.mcreator.catastrophemod.block.CorrodedSteelPanelBlock;
import net.mcreator.catastrophemod.block.CorrodedReinforcedConcreteBlock;
import net.mcreator.catastrophemod.block.CorrodedGrateBlock;
...
public class CatastropheModModBlocks {
	...
	public static final RegistryObject<Block> CORRODED_GRATE = REGISTRY.register("corroded_grate", () -> new CorrodedGrateBlock());
	public static final RegistryObject<Block> STEEL_PLATING = REGISTRY.register("steel_plating", () -> new SteelPlatingBlock());
	public static final RegistryObject<Block> CORRODED_STEEL_PLATING = REGISTRY.register("corroded_steel_plating", () -> new CorrodedSteelPlatingBlock());
	public static final RegistryObject<Block> STEEL_PANEL = REGISTRY.register("steel_panel", () -> new SteelPanelBlock());
	public static final RegistryObject<Block> CORRODED_STEEL_PANEL = REGISTRY.register("corroded_steel_panel", () -> new CorrodedSteelPanelBlock());
	...
	public static final RegistryObject<Block> CORRODED_REINFORCED_CONCRETE = REGISTRY.register("corroded_reinforced_concrete", () -> new CorrodedReinforcedConcreteBlock());
}
