...
import net.mcreator.catastrophemod.item.ThunderstrikeItem;
...
import net.mcreator.catastrophemod.item.JellyfishPendantItem;
...
import net.mcreator.catastrophemod.item.GasolineCanisterItem;
import net.mcreator.catastrophemod.item.FrozenShieldItem;
import net.mcreator.catastrophemod.item.FreezingStaffItem;
import net.mcreator.catastrophemod.item.ForgeKeyItem;
import net.mcreator.catastrophemod.item.ForceMissilesItem;
...
import net.mcreator.catastrophemod.item.ElectrifiedArmorItem;
...
import net.mcreator.catastrophemod.item.CopperRoundItem;
...
public class CatastropheModModItems {
	...
	public static final RegistryObject<Item> BRASS_COLORED_SHOVEL = REGISTRY.register("brass_colored_shovel", () -> new BrassColoredShovelItem());
	...
	public static final RegistryObject<Item> FORCE_MISSILES = REGISTRY.register("force_missiles", () -> new ForceMissilesItem());
	public static final RegistryObject<Item> VOLTBLADE_SPAWN_EGG = REGISTRY.register("voltblade_spawn_egg", () -> new ForgeSpawnEggItem(CatastropheModModEntities.VOLTBLADE, -1534633, -5875453, new Item.Properties()));
	public static final RegistryObject<Item> THUNDERSTRIKE = REGISTRY.register("thunderstrike", () -> new ThunderstrikeItem());
	public static final RegistryObject<Item> LIGHTHOUSE_POWER_BLOCK = block(CatastropheModModBlocks.LIGHTHOUSE_POWER_BLOCK);
	public static final RegistryObject<Item> ARC_STRIKER_SPAWN_EGG = REGISTRY.register("arc_striker_spawn_egg", () -> new ForgeSpawnEggItem(CatastropheModModEntities.ARC_STRIKER, -1342132, -14942224, new Item.Properties()));
	public static final RegistryObject<Item> JELLYFISH_PENDANT = REGISTRY.register("jellyfish_pendant", () -> new JellyfishPendantItem());
	public static final RegistryObject<Item> SURGE_BREAKER_SPAWN_EGG = REGISTRY.register("surge_breaker_spawn_egg", () -> new ForgeSpawnEggItem(CatastropheModModEntities.SURGE_BREAKER, -38110, -220341, new Item.Properties()));
	public static final RegistryObject<Item> FORGE_KEY = REGISTRY.register("forge_key", () -> new ForgeKeyItem());
	public static final RegistryObject<Item> CRYSTALLINE_EDGE = REGISTRY.register("crystalline_edge", () -> new CrystallineEdgeItem());
	public static final RegistryObject<Item> ACCURSED_WITCH_SPAWN_EGG = REGISTRY.register("accursed_witch_spawn_egg", () -> new ForgeSpawnEggItem(CatastropheModModEntities.ACCURSED_WITCH, -15395563, -14757053, new Item.Properties()));
	public static final RegistryObject<Item> YELLOW_SEA_SHELL = block(CatastropheModModBlocks.YELLOW_SEA_SHELL);
	public static final RegistryObject<Item> BLUE_SEA_SHELL = block(CatastropheModModBlocks.BLUE_SEA_SHELL);
	public static final RegistryObject<Item> RED_SEA_SHELL = block(CatastropheModModBlocks.RED_SEA_SHELL);
	public static final RegistryObject<Item> PURPLE_SEA_SHELL = block(CatastropheModModBlocks.PURPLE_SEA_SHELL);
	public static final RegistryObject<Item> PINK_SEA_SHELL = block(CatastropheModModBlocks.PINK_SEA_SHELL);
	public static final RegistryObject<Item> ELECTRIFIED_DIODE = block(CatastropheModModBlocks.ELECTRIFIED_DIODE);
	public static final RegistryObject<Item> ELECTRIFIED_ARMOR_HELMET = REGISTRY.register("electrified_armor_helmet", () -> new ElectrifiedArmorItem.Helmet());
	...
	public static final RegistryObject<Item> CHISELED_SHALE_BRICKS = block(CatastropheModModBlocks.CHISELED_SHALE_BRICKS);
	public static final RegistryObject<Item> SHALE_SLAB = block(CatastropheModModBlocks.SHALE_SLAB);
	public static final RegistryObject<Item> SHALE_BRICKS_SLAB = block(CatastropheModModBlocks.SHALE_BRICKS_SLAB);
