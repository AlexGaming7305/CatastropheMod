...
public class Modelaccursed_dagger<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("catastrophe_mod", "modelaccursed_dagger"), "main");
	public final ModelPart accursed_dagger;

	public Modelaccursed_dagger(ModelPart root) {
		this.accursed_dagger = root.getChild("accursed_dagger");
	}

	public static LayerDefinition createBodyLayer() {
		MeshDefinition meshdefinition = new MeshDefinition();
		PartDefinition partdefinition = meshdefinition.getRoot();
		PartDefinition accursed_dagger = partdefinition.addOrReplaceChild("accursed_dagger",
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
		accursed_dagger.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
	}
