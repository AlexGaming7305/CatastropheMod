...
public class Modelknife_of_proficiency<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("catastrophe_mod", "modelknife_of_proficiency"), "main");
	public final ModelPart knife_of_proficiency;

	public Modelknife_of_proficiency(ModelPart root) {
		this.knife_of_proficiency = root.getChild("knife_of_proficiency");
	}

	public static LayerDefinition createBodyLayer() {
		MeshDefinition meshdefinition = new MeshDefinition();
		PartDefinition partdefinition = meshdefinition.getRoot();
		PartDefinition knife_of_proficiency = partdefinition.addOrReplaceChild("knife_of_proficiency",
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
		knife_of_proficiency.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
	}
