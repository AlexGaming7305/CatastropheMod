...
public class Modeltracking_disc<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("catastrophe_mod", "modeltracking_disc"), "main");
	public final ModelPart tracking_disc;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition tracking_disc = partdefinition.addOrReplaceChild("tracking_disc", CubeListBuilder.create().texOffs(-16, 0).addBox(-8.0F, 0.0F, -8.0F, 16.0F, 0.0F, 16.0F, new CubeDeformation(0.0F)),
