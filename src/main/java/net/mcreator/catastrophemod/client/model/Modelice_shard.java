...
public class Modelice_shard<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("catastrophe_mod", "modelice_shard"), "main");
	public final ModelPart ice_shard;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition ice_shard = partdefinition.addOrReplaceChild("ice_shard",
				CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -8.0F, 0.0F, 8.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(0, 0).addBox(0.0F, -8.0F, -4.0F, 0.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)),
