...
public class Modelwuflar_laser<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("catastrophe_mod", "modelwuflar_laser"), "main");
	public final ModelPart wuflar_laser;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition wuflar_laser = partdefinition.addOrReplaceChild("wuflar_laser", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -5.0F, -1.0F, 2.0F, 10.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 19.0F, 0.0F));
