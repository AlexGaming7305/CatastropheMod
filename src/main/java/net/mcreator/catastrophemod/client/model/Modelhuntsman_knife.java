...
public class Modelhuntsman_knife<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("catastrophe_mod", "modelhuntsman_knife"), "main");
	public final ModelPart huntsman_knife;

	public Modelhuntsman_knife(ModelPart root) {
		this.huntsman_knife = root.getChild("huntsman_knife");
	}

	public static LayerDefinition createBodyLayer() {
		MeshDefinition meshdefinition = new MeshDefinition();
		PartDefinition partdefinition = meshdefinition.getRoot();
		PartDefinition huntsman_knife = partdefinition.addOrReplaceChild("huntsman_knife",
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
		huntsman_knife.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
	}
