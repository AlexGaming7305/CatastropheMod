...
public class Modelcrystal_shard<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("catastrophe_mod", "modelcrystal_shard"), "main");
	public final ModelPart crystal_shard;
