...
public class Modelblood_knife<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("catastrophe_mod", "modelblood_knife"), "main");
	public final ModelPart blood_knife;

	public Modelblood_knife(ModelPart root) {
		this.blood_knife = root.getChild("blood_knife");
	}

	public static LayerDefinition createBodyLayer() {
		MeshDefinition meshdefinition = new MeshDefinition();
		PartDefinition partdefinition = meshdefinition.getRoot();
		PartDefinition blood_knife = partdefinition.addOrReplaceChild("blood_knife",
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
		blood_knife.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
	}
