...
public class Modeliron_pellet<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("catastrophe_mod", "modeliron_pellet"), "main");
	public final ModelPart iron_pellet;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition iron_pellet = partdefinition.addOrReplaceChild("iron_pellet", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
