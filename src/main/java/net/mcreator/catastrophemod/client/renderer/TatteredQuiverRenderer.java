...
public class TatteredQuiverRenderer implements ICurioRenderer {
	private static final ResourceLocation TEXTURE = new ResourceLocation("catastrophe_mod", "textures/entities/tattered_quiver_texture.png");
	private final Modelquiver model;

	public TatteredQuiverRenderer() {
		this.model = new Modelquiver(Minecraft.getInstance().getEntityModels().bakeLayer(CatastropheModModLayerDefinitions.TATTERED_QUIVER));
	}
