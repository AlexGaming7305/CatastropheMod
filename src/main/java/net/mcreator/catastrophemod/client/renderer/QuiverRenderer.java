...
public class QuiverRenderer implements ICurioRenderer {
	private static final ResourceLocation TEXTURE = new ResourceLocation("catastrophe_mod", "textures/entities/quiver_texture.png");
	private final Modelquiver model;

	public QuiverRenderer() {
		this.model = new Modelquiver(Minecraft.getInstance().getEntityModels().bakeLayer(CatastropheModModLayerDefinitions.QUIVER));
	}
