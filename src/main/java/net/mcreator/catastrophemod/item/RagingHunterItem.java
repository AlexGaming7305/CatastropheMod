...
public class RagingHunterItem extends Item implements GeoItem {
	...
	public void initializeClient(Consumer<IClientItemExtensions> consumer) {
		...
		consumer.accept(new IClientItemExtensions() {
			private final BlockEntityWithoutLevelRenderer renderer = new RagingHunterItemRenderer();
			...
			private static final HumanoidModel.ArmPose RagingHunterPose = HumanoidModel.ArmPose.create("RagingHunter", false, (model, entity, arm) -> {
	...
	private PlayState idlePredicate(AnimationState event) {
		if (this.transformType != null ? true : false) {
			if (this.animationprocedure.equals("empty")) {
				event.getController().setAnimation(RawAnimation.begin().thenLoop("animation.raging_hunter.idle"));
