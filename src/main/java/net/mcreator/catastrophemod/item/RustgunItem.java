...
public class RustgunItem extends Item implements GeoItem {
	...
	public void initializeClient(Consumer<IClientItemExtensions> consumer) {
		...
		consumer.accept(new IClientItemExtensions() {
			private final BlockEntityWithoutLevelRenderer renderer = new RustgunItemRenderer();
			...
			private static final HumanoidModel.ArmPose RustgunPose = HumanoidModel.ArmPose.create("Rustgun", false, (model, entity, arm) -> {
