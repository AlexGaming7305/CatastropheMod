...
import net.mcreator.catastrophemod.procedures.CrystallineEdgeLivingEntityIsHitWithToolProcedure;
...
public class CrystallineEdgeItem extends SwordItem {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("\u00A7aRight-click: \u00A77Charges the blade"));
		list.add(Component.literal("\u00A77Attacking when the blade is fully charged will perform a big aoe slash dealing \u00A79+50% Melee Damage"));
	}
	...
	public boolean hurtEnemy(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
		...
		CrystallineEdgeLivingEntityIsHitWithToolProcedure.execute(entity.level(), entity, sourceentity);
		return retval;
	}
