...
import net.mcreator.catastrophemod.procedures.GiantIsopodRightClickedOnEntityProcedure;
...
public class GiantIsopodEntity extends PathfinderMob implements GeoEntity {
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		GiantIsopodRightClickedOnEntityProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
