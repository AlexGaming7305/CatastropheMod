...
public class RipsawSawbladeEntity extends TamableAnimal implements GeoEntity {
	...
	public RipsawSawbladeEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(CatastropheModModEntities.RIPSAW_SAWBLADE.get(), world);
	}

	public RipsawSawbladeEntity(EntityType<RipsawSawbladeEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		RipsawSawbladeOnInitialEntitySpawnProcedure.execute(world, this.getX(), this.getY(), this.getZ(), this);
		return retval;
	}
	...
	public void baseTick() {
		super.baseTick();
		RipsawSawbladeOnEntityTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		RipsawSawbladeEntity retval = CatastropheModModEntities.RIPSAW_SAWBLADE.get().create(serverWorld);
	...
	private PlayState movementPredicate(AnimationState event) {
		if (this.animationprocedure.equals("empty")) {
			return event.setAndContinue(RawAnimation.begin().thenLoop("animation.ripsaw_sawblade.idle"));
		}
