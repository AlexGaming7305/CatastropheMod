...
import net.mcreator.catastrophemod.procedures.LightningBladeOnInitialEntitySpawnProcedure;
import net.mcreator.catastrophemod.procedures.LightningBladeOnEntityTickUpdateProcedure;
...
public class LightningBladeEntity extends TamableAnimal implements GeoEntity {
	...
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(LightningBladeEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(LightningBladeEntity.class, EntityDataSerializers.STRING);
	...
	public LightningBladeEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(CatastropheModModEntities.LIGHTNING_BLADE.get(), world);
	}

	public LightningBladeEntity(EntityType<LightningBladeEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		LightningBladeOnInitialEntitySpawnProcedure.execute(world, this.getX(), this.getY(), this.getZ(), this);
		return retval;
	}
	...
	public void baseTick() {
		super.baseTick();
		LightningBladeOnEntityTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		LightningBladeEntity retval = CatastropheModModEntities.LIGHTNING_BLADE.get().create(serverWorld);
	...
	private PlayState movementPredicate(AnimationState event) {
		if (this.animationprocedure.equals("empty")) {
			return event.setAndContinue(RawAnimation.begin().thenLoop("animation.lightning_blade.idle"));
		}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(LightningBladeEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
