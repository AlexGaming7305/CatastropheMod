...
public class SeaBowStopChargingProcedure {
	@SubscribeEvent
			...
			if ((entity.getCapability(CatastropheModModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new CatastropheModModVariables.PlayerVariables())).sea_bow_charge >= 22) {
				{
					...
					entity.getCapability(CatastropheModModVariables.PLAYER_VARIABLES_CAPABILITY, null).ifPresent(capability -> {
						capability.sea_bow_ready = _setval;
					...
					if (!projectileLevel.isClientSide()) {
						Projectile _entityToSpawn = new Object() {
							public Projectile getArrow(Level level, Entity shooter, float damage, int knockback) {
								AbstractArrow entityToSpawn = new SeaCrystalShardProjectileEntity(CatastropheModModEntities.SEA_CRYSTAL_SHARD_PROJECTILE.get(), level);
