...
.getOrStartProgress(_plr0.server.getAdvancements().getAdvancement(new ResourceLocation("catastrophe_mod:lepidopterist"))).isDone())) {if (==true&&==true&&==true&&==true&&==true&&==true) {if(entity instanceof ServerPlayer _player) {
