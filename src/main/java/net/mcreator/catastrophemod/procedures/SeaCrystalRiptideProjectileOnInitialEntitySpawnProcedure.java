...
public class SeaCrystalRiptideProjectileOnInitialEntitySpawnProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		entity.setNoGravity(true);
		{
			...
			for (Entity entityiterator : _entfound) {
				...
				}.compareDistOf(x, y, z)).findFirst().orElse(null)) instanceof SeaCrystalRiptideProjectileEntity)) {
